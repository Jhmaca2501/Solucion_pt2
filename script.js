...
function calculateCommissions() {
    ...
    const totalComisiones = comision1 + comision2 + comision3; //Esta es la constante inicializada para el total de comisiones
    const totalRecibir = sueldoBase + totalComisiones; //Esta es la constante inicializada para el total a recibir
